...
import { getPromotions, getPromotionById } from "../services/promotionService";
    ...
    >
      <div className="row align-items-center g-4">
        <div className="col-lg-7">
          ...
          <p className="fw-bold text-muted">{slide.sub}</p>
        ...
        {slides.map((_, index) => (
          <button
            ...
            style={{
              ...
              borderRadius: "999px",
              border: "none",
              background: index === current ? slide.accent : "#fff",
              transition: "0.3s",
            }}
          ></button>
        ))}
...
function HomePage() {
  ...
  const loadHomeData = async () => {
    try {
      ...
      if (promotionResult.data.length > 0) {
        const firstPromotionId = promotionResult.data[0].id;
        const promotionDetail = await getPromotionById(firstPromotionId);
        setSaleProducts(promotionDetail.data.products || []);
      }
    } catch (error) {
      console.log(error);
    }
  ...
  const featuredProducts = products.filter((p) => p.rating >= 4.7);
    ...
    <div style={{ backgroundColor: "#f5f5f5", minHeight: "100vh" }}>
      ...
      <div className="container-fluid px-4 px-lg-5 py-5">
        <div className="bg-white rounded-5 shadow-sm p-5">
          <h2 className="fw-bold mb-5">Danh mục nổi bật</h2>
            ...
            {categories.map((item) => (
              ...
              >
                <div
                  ...
                  onClick={() => {
                    if (item.id === 0) navigate("/products");
                    else navigate(`/products?categoryId=${item.id}`);
                  }}
                >
                  <div
                    ...
                    style={{
                      ...
                      height: "95px",
                      borderRadius: "50%",
                      background: "linear-gradient(135deg, #8ec5ff, #f7a8ff)",
                      fontSize: "40px",
                      color: "white",
                    }}
                  >
      ...
      <div className="container-fluid px-4 px-lg-5 pb-5">
        <div className="bg-white rounded-5 shadow-sm p-5">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="fw-bold">Thương hiệu nổi bật</h2>

            <Link to="/brands" className="btn btn-dark rounded-pill px-4">
              Xem tất cả
            </Link>
          </div>
          ...
          <AutoScrollRow speed={1}>
            {brands.map((brand) => (
              <div className="auto-scroll-card" key={brand.id}>
                <Link
                ...
                >
                  ...
                  >
                    <img
                      src={`http://localhost:5114/images/${brand.bannerUrl}`}
                      alt={brand.name}
                      className="auto-scroll-img"
                      style={{
                        height: "180px",
      ...
      <div className="container-fluid px-4 px-lg-5 pb-5">
        <div className="bg-white rounded-5 shadow-sm p-5">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h2 className="fw-bold mb-1">Chương trình khuyến mại</h2>
              <p className="text-muted mb-0">
                Các ưu đãi nổi bật đang diễn ra tại Cindybeauty Shop
              </p>
            </div>

            <Link to="/promotion" className="btn btn-danger rounded-pill px-4">
              Xem tất cả
            </Link>
          </div>
          ...
          <AutoScrollRow speed={1}>
            {promotions.map((promotion) => (
              <div className="auto-scroll-card" key={promotion.id}>
                <Link
                ...
                >
                  ...
                  >
                    <img
                      ...
                      onError={(e) => {
                        e.currentTarget.src =
                          "https://via.placeholder.com/600x300?text=Promotion";
                      }}
                    />
                    ...
                    <div className="card-body p-3">
                      ...
                      <h6 className="fw-bold mb-2">{promotion.title}</h6>
      ...
      <div className="container-fluid px-4 px-lg-5 pb-5">
        <div className="bg-white rounded-5 shadow-sm p-5">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="fw-bold">Sản phẩm đang sale 🔥</h2>

            <Link to="/flash-sale" className="btn btn-dark rounded-pill px-4">
              Săn sale
            </Link>
          </div>
        ...
        <div className="bg-white rounded-5 shadow-sm p-5">
          <div className="row g-4 align-items-center">
            <div className="col-lg-6">
              <h2 className="fw-bold mb-3">Về Cindybeauty Shop</h2>
              ...
              <div className="row g-3 mt-3">
                ...
                <div className="col-6">
                  <div className="p-3 bg-light rounded-4">
                    <h4 className="fw-bold mb-0">{brands.length}+</h4>
            ...
            <div className="col-lg-6">
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, #ffe6ef, #f4f8ff)",
                }}
              >
                ...
                <Link to="/stores" className="btn btn-dark rounded-pill px-4 mt-2">
